            ...
            <tr>
                <td>
                    <table width="100%" style="padding: 10px 0px; text-align: center;">
                        <tr>
                            <td align="center">
                                <span style="font-size: 14px;">This email has been submitted from 'Know More Home Page'</span>
                            </td>
                        </tr>
                        <tr>
                            <td align="center">
                                <span style="font-size: 24px; font-weight: 700;">{{ $dataRecieved['form_email'] }}</span>
                            </td>
                        </tr>
                    </table>
                </td>
            ...
            <tr>
                <td>
                    <table width="100%" style="font-size: 18px;">
                        <tr>
                            <td>
                                <b style="color: #046DFB; font-weight: 700;">Topic:</b>
                            </td>
                        </tr>
                        <tr>
                            <td>
                                <span style="text-transform: capitalize;">{{ $dataRecieved['form_topic'] }}</span>
                            </td>
                        </tr>
                    </table>
                </td>
